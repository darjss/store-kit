          ...
          <article class="mx-auto w-[min(900px,100%)]">
            ...
            >
              ...
              <Show when={shouldPollOrderStatus(order())}>
                <button
                  class="border-ink bg-orange text-ink mr-2 inline-flex min-h-12.5 cursor-pointer items-center justify-center border-3 px-4 py-3 font-black no-underline transition-transform duration-100 active:scale-[0.97] disabled:cursor-not-allowed disabled:opacity-55 motion-reduce:transition-none"
                  type="button"
              ...
              <Show when={order().payment?.method === 'qpay' && order().payment?.status !== 'paid'}>
                <button
                  class="border-ink bg-orange text-ink inline-flex min-h-12.5 cursor-pointer items-center justify-center border-3 px-4 py-3 font-black no-underline transition-transform duration-100 active:scale-[0.97] disabled:cursor-not-allowed disabled:opacity-55 motion-reduce:transition-none"
                  type="button"
