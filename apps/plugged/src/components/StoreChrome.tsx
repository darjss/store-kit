...
const linkClass =
  'relative grid min-h-11 min-w-24 place-items-center content-center border-0 border-r border-white/25 bg-transparent px-2 py-1 text-center leading-tight text-inherit no-underline [overflow-wrap:anywhere] max-md:min-h-16 max-md:min-w-0 max-md:px-1'
