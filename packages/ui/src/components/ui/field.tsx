...
const FieldGroup = (props: FieldGroupProps) => {
  ...
  return (
    <div
      ...
      class={cn(
        'group/field-group z-field-group @container/field-group flex w-full flex-col',
        local.class,
      )}
      {...others}
    />
...
const FieldDescription = (props: FieldDescriptionProps) => {
  ...
  return (
    <p
      ...
      class={cn(
        'z-field-description leading-normal font-normal group-has-data-[orientation=horizontal]/field:text-balance',
